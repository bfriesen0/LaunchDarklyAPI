...
${nuget_cmd} install src/LaunchDarklyAPI/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/LaunchDarklyAPI.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/LaunchDarklyAPI.dll \
-recurse:'src/LaunchDarklyAPI/*.cs' \
-doc:bin/LaunchDarklyAPI.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/LaunchDarklyAPI.dll was created successfully"
fi
