...
namespace LaunchDarklyAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Rollout :  IEquatable<Rollout>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Rollout" /> class.
        /// </summary>
        /// <param name="variations">variations.</param>
        public Rollout(List<WeightedVariation> variations = default(List<WeightedVariation>))
        {
        ...
        {
            return this.Equals(input as Rollout);
        }

        /// <summary>
        /// Returns true if Rollout instances are equal
        /// </summary>
        /// <param name="input">Instance of Rollout to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Rollout input)
        {
            if (input == null)
                return false;
